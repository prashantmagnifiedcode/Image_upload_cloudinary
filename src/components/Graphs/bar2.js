...
const StockChart = ({ info }) => {
    ...
    return (
        <>
            <div className="rounded shadow-xl overflow-hidden w-full p-1 md:flex" style={{ maxWidth: '900px' }}>
                <div className="flex w-full md:w-1/2 px-2 pb-4 pt-4 bg-indigo-500 text-white items-center">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex w-full text-xs ">
                            ...
                            <div className="flex w-7/12">
                                <div className="flex-1 px-2 text-left font-semibold">Market Cap</div>
